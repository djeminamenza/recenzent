...
class AuthController extends Controller
{
	...
	public function register()
	{
		...
		return $this->_render($this->config->views['register'], ['config' => $this->config, 'podaci'=>$podaci]);
	}
...
/* 
			$podaci['id'] = $biografijaID;
			$podaci['opis'] = $biografijaName;
			$user>update($biografijaID, $podaci) */; 
			// Success!
