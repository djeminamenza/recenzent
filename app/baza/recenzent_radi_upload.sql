...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2021 at 05:32 PM
...
(172, '::1', 'pera@peric.com', 1, '2021-09-02 16:47:40', 1),
(173, '::1', 'kiki@kiki.com', 12, '2021-09-02 17:53:20', 1),
(174, '::1', 'pera@peric.com', 1, '2021-09-03 05:42:50', 1),
(175, '::1', 'pera@peric.com', 1, '2021-09-04 10:04:31', 1);
...
INSERT INTO `rezultat` (`id`, `id_poziv`, `id_kateg`, `id_status`, `naziv`, `datum`, `opis`, `clanovi`, `god_rez`, `datum_prijave`) VALUES
(3, 0, 0, 0, 'Obrisi_me', '0000-00-00', '', '', '', '0000-00-00'),
(4, 0, 0, 0, 'Obrisi_me_2', '0000-00-00', '', '', '', '0000-00-00'),
(5, 0, 0, 0, 'Dzimi', '0000-00-00', '', '', '', '0000-00-00');
...
CREATE TABLE `users` (
  ...
  `id_nac` int(11) UNSIGNED NOT NULL,
  `id_oblast` int(11) NOT NULL,
...
(12, 'kiki@kiki.com', 'kiki', 'Kiki', 'Kikic', 'Soko Stark', 1, 1, 1, 1, 'Kikina 99', '66666', 'www.kikic.com', '', '666666', '$2y$10$QoKtGWlymxX2SHgy6WGGE.VR.qSoethfYJa4D6CW0xMqeBtpikJF2', NULL, NULL, NULL, '6efbd8798bdecccd102a0eecf389cbcc', NULL, NULL, 1, 0, '2021-09-02 17:52:48', '2021-09-02 17:52:48', NULL);
