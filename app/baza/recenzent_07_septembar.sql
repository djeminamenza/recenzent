...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2021 at 12:28 AM
...
INSERT INTO `rezultat` (`id`, `id_poziv`, `id_kateg`, `id_status`, `naziv`, `datum`, `opis`, `clanovi`, `biografije`, `god_rez`, `datum_prijave`) VALUES
(4, 0, 0, 0, 'Љубљанска банка', '0000-00-00', 'sabirali smo', '', '', '', '0000-00-00');
...
(21, 'kiki@kiki.com', 'kiki', 'Kiki', 'Kikic', 'MGM', 2, 1, 3, 3, 'Kikina 99', '066', 'www.kikic.com', '', '7', '$2y$10$y87FgT0hQYUj/Kdgjzx/DeN8706SKQmEI39ix2heANmZ9PBJbLwHq', NULL, NULL, NULL, '24883946fed2a3a4d893f04401ee7701', NULL, NULL, 0, 0, '2021-09-06 15:18:08', '2021-09-06 15:18:08', NULL);
